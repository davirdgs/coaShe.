...
class DisponibilidadeView: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let index = indexPath.row + (24 * self.day)
        
        if(self.disponibilidade[index] as! Bool){
